	 ...
	 <form action="mic_upload_process.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return valForm(this);"> 	 
		<div class="row">
		  ...
		  <div class="row" >
		   ...
		   <div class="row" >
			<div class="col-sm-4">
			  <h4 style="text-align: left;"><span style="font-weight: normal;">Are there any wells that need to be excluded? </span><br>
              </h4>
			</div>
		    <div class="col-sm-6">
		     ...
		     <div class="row" >
			<div class="col-sm-4">
			  <h4 style="text-align: left;"><span style="font-weight: normal;">What is the start time of your data? </span><br>
              </h4>
			</div>
		    <div class="col-sm-6">
           ...
           <div class="row">
			...
			<img src="images/tem1.png" style="width:500px;height:150px;">
              <h5>Upload your .txt file in format shown in the template</br>Please note: This program was designed to work with data from the SoftMax™ Pro software converted to a .txt file. As such, data can come from other scanners as long as the plates are formatted the same way. However, there may still be technical issues if the data does not come from the SoftMax™ Pro software. </h5>
            </div>
			<div class="col-sm-6">
